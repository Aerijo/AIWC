...
static void printUsage()
{
  cout
    ...
    << "Options:" << endl
    << "     --aiwc                    "
       "Perform Architecture Independent Workload Characterization"
    << endl
    << "                               For examples on how these features can "
       "be used for diversity "
    << endl
    << "                               analysis and device predictions see:  "
    << endl
    << "                               -> "
       "https://github.com/BeauJoh/"
